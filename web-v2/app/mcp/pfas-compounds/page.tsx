            ...
            items={[
              {
                ...
                body:
                  "SAWGraph, AOP-Wiki, SPOKE-OKN, NDE, Wikidata, GeneLab, and Ubergraph.",
              },
              {
                label: "WOBD contribution",
                body:
                  "Links contamination observations to molecular mechanisms, disease pathways, and experimental datasets.",
              },
              {
                label: "Audit trail",
                body:
                  "Each claim is framed as convergent evidence from named source graphs, not as a single-source assertion.",
              },
            ]}
          />
        </section>

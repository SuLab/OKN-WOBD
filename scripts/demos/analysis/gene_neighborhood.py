...
Usage:
    from analysis import GeneNeighborhoodQuery

    querier = GeneNeighborhoodQuery()
    neighborhood = querier.query_all(symbol="CD19")

    # Or run as script:
    python -m analysis.gene_neighborhood CD19
    python -m analysis.gene_neighborhood --symbol CD19

    # By NCBI Gene ID
    python -m analysis.gene_neighborhood --ncbi 930

    # With custom limits
    python -m analysis.gene_neighborhood CD19 --limit 20
    python -m analysis.gene_neighborhood CD19 --spoke-limit 15 --wikidata-limit 25

    # Output formats
    python -m analysis.gene_neighborhood CD19 --format json
    python -m analysis.gene_neighborhood CD19 --format table

    # Save to file
    python -m analysis.gene_neighborhood CD19 -o cd19_neighborhood.json

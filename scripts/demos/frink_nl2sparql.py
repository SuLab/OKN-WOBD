...
Usage:
    # Basic usage
    python frink_nl2sparql.py "What are the subtypes of infectious disease?"

    # Specify output format
    python frink_nl2sparql.py "Find genes related to apoptosis" --format json
    python frink_nl2sparql.py "Find genes related to apoptosis" --format table
    python frink_nl2sparql.py "Find genes related to apoptosis" --format summary

    # Specify graphs to query
    python frink_nl2sparql.py "Find disease datasets" --graphs ubergraph nde

    # Show generated SPARQL without executing
    python frink_nl2sparql.py "Find all cancer types" --dry-run
